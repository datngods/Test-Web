            ...
            <div class="animated fadeIn">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{$num_items}}</span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{count($bills)}}</span></div>
                                            <div class="stat-heading">Number of Bills</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{$num_users}}</span></div>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Bill in the last 30 days</h4>
                                </div>
                                <div class="card-body--">
                                        ...
                                        <table class="table ">
                                            ...
                                            @for($i=0; $i<count($bills); $i++)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-complete">{{$bills[$i]->checked}}</span>
                                                    </td>
                                                </tr>
                                            @endfor
                                            </tbody>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">The 10 newest items up-to-date</h4>
                            </div>
                            <div class="card-body--">
                                <div class="table-stats order-table ov-h">
                                    <table class="table ">
                                        ...
                                        <tbody>
                                        @for($i=0; $i<count($newest_items); $i++)
                                            <tr>
                                                <td class="serial">{{$i."."}}</td>
                                                ...
                                                @else
                                                <td>
                                                    <span class="badge badge-complete">{{'warning'}}</span>
                                                </td>
                                                @endif
                                            </tr>
                                        @endfor
